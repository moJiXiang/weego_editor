...
module.exports = function(app) {
	...
	app.get('/restaurants/:pageLimit/:pageIndex/:city_name/:areaname/:lifename/:most_popular/:best_dinnerchoics/:michilin_flag/:local_flag', routes.life.getRestaurantByPage);
