...
//                'margin-top':'-44px'
            ...
            this.backdrop(function (it) {
                var transition = $.support.transition && that.$element.hasClass('fade')
                if (!that.$element.parent().length) {
                    that.$element.appendTo(it) //don't move modals dom position
                }
                ...
                that.$element
                    .addClass('in')
                    .attr('aria-hidden', false).css('z-index', that.options.z_index);
            ...
            this.$backdrop = null
            this.$element.remove(); //关闭后把这个对话框删除
            this.$element = null;
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                this.$backdrop = $('<div class="modal-backdrop ' + animate + '" style="z-index:' + that.options.z_index + '; height:'+$(window).height() + 'px'+';opacity: 1;top:'+$(document).scrollTop() +'px"/>')
...
//          )
    ...
    $.fn.modal.defaults = {
        backdrop:true, keyboard:true, show:true, z_index:2000
    }
...
//            $tip.find('.popover-content > *')[this.options.html ? 'html' : 'text'](content)
    ...
    $.fn.popover.defaults = $.extend({}, $.fn.tooltip.defaults, {
        placement:'right', trigger:'click', content:'', template:'<div class="popover"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content">' +
            '<ul>' +
            '<li id="personpage">' +
            '<a href="#">个人主页</a>' +
            '</li>' +
